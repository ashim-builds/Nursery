...
import { EsewaPaymentGateway } from './esewa.gateway.js';
...
export class PaymentGatewayFactory {
  private static gateways: Map<PaymentMethod, IPaymentGateway> = new Map<PaymentMethod, IPaymentGateway>([
    ...
    [PaymentMethod.ESEWA, new EsewaPaymentGateway() as IPaymentGateway],
    ...
    [PaymentMethod.ONLINE, new EsewaPaymentGateway() as IPaymentGateway],
  ]);
