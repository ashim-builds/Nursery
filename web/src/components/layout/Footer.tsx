...
export const Footer: React.FC = () => {
  ...
  const phone =
    siteSettings?.phone && siteSettings.phone !== "9800000000"
      ...
      : "9815155580";
  const address =
    siteSettings?.address || "Pokhara-26, Arghau Chowk, Pokhara";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_2fr] gap-12 pb-12">
          <div className="max-w-sm">
            <div className="flex items-center gap-3 mb-5">
              <img
                ...
                className="w-12 h-12 rounded-2xl object-contain bg-white p-1 shadow-lg shadow-black/10 border border-slate-100/50"
              />
              <div>
                <span className="block font-serif font-bold text-2xl text-white leading-none">
                  {businessName}
                </span>
            ...
            <p className="text-sm text-forest-300 leading-relaxed mb-6">
              Fresh flowers and nursery plants chosen to make Pokhara homes feel
              more alive.
            </p>
            <div className="space-y-3 text-xs text-forest-300">
              ...
              <a
                ...
                className="flex items-center gap-3 hover:text-white transition-colors"
              >
                <Facebook size={15} className="text-accent shrink-0" />
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8">
            <div>
              <h4 className="text-[11px] uppercase tracking-[0.18em] text-emerald-300 mb-4">
                Explore
              </h4>
              <nav className="space-y-3 text-sm text-forest-200">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 hover:text-white transition-colors"
                >
                  Search Plants <ArrowUpRight size={13} />
                </Link>
              </nav>
            </div>
            <div>
              ...
              <nav className="space-y-3 text-sm text-forest-200">
                ...
                <Link
                  ...
                  className="flex items-center gap-1 hover:text-white transition-colors"
                >
                  Track an order <ArrowUpRight size={13} />
                </Link>
                <Link
                  to="/privacy"
                  className="flex items-center gap-1 hover:text-white transition-colors"
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <p className="text-sm text-forest-200 leading-relaxed mb-2">
                {siteSettings?.openingHours || "Sun - Sat: 8:00 AM - 7:00 PM"}
              </p>
              <p className="text-xs text-forest-400 leading-relaxed">
                Delivery across Pokhara. Rs. 100 below Rs. 2,000; free delivery
                from Rs. 2,000.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-y border-forest-900 py-5 mb-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-forest-200">
              Careful valley-wide delivery
            </span>
          </div>
          <div className="flex items-center gap-3">
            <ShieldCheck size={18} className="text-accent" />
            <span className="text-xs text-forest-200">
              Healthy, acclimatized plants
            </span>
          </div>
          <div className="flex items-center gap-3">
            <Heart size={18} className="text-accent" />
            <span className="text-xs text-forest-200">
              Made with local craft
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <Link
            to="/admin/login"
            className="text-[11px] text-forest-400 hover:text-emerald-400 transition-colors inline-flex items-center gap-1"
          >
